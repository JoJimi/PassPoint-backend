...
public class QuestionSearchService {
    ...
    public Page<QuestionSearchResponse> search(String keyword, String mainCategory,Pageable pageable) {
        return questionSearchRepository.searchQuestions(keyword, mainCategory, pageable)
