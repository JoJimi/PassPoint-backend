...
/**
 * 사용자
 * - 소셜 로그인(google/kakao)으로 가입
 * - (oauth_provider, oauth_id) 조합은 유니크: 같은 소셜 계정으로 중복 가입할 수 없다
 */
...
public class User extends BaseEntity {
    ...
    private OAuthProvider oauthProvider;    // google | kakao

    @Column(name = "oauth_id", nullable = false)
    private String oauthId;                 // 소셜 측 고유 ID
    ...
    @Builder
    private User(OAuthProvider oauthProvider, String oauthId, String email, String nickname, String statusMessage) {
